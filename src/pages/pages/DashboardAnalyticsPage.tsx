  ...
  switch (range) {
    case '24h':
      return Array.from({ length: 24 }, (_, i) => ({
        date: `${i}:00`,
        qr1: Math.floor((1 + Math.random() * 10) * multiplier),
    ...
    case '7d':
      return ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => ({
        date: day,
        qr1: Math.floor((42 + Math.random() * 200) * multiplier),
        qr2: Math.floor((18 + Math.random() * 90) * multiplier),
        cvr: 44 + Math.floor(Math.random() * 4),
      }));
    case '30d':
      return Array.from({ length: 7 }, (_, i) => ({
        date: `Jan ${(i + 1) * 5}`,
        qr1: Math.floor((4 + i * 100 + Math.random() * 100) * multiplier),
        qr2: Math.floor((1 + i * 50 + Math.random() * 50) * multiplier),
        cvr: 44 + Math.floor(Math.random() * 4),
      }));
    case '90d':
      return Array.from({ length: 13 }, (_, i) => ({
        date: `Wk ${i + 1}`,
        qr1: Math.floor((2800 + i * 20+ Math.random() * 500) * multiplier),
        qr2: Math.floor((1200 + i * 10 + Math.random() * 200) * multiplier),
        cvr: 44 + Math.floor(Math.random() * 4),
      }));
  }
};
